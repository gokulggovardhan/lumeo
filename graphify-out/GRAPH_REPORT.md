...
## Summary
- 3295 nodes · 6822 edges · 229 communities (194 shown, 35 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 79 edges (avg confidence: 0.66)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `99853eab`
...
6. `useAnalytics()` - 37 edges
7. `resolveFont()` - 36 edges
8. `getToolBlockedState()` - 36 edges
...
Cohesion: 0.07
Nodes (56): HeicToJpegPage(), HeicToJpegTool, metadata, breadcrumbSchema, CompressPdfPage(), CompressPdfTool, softwareSchema, breadcrumbSchema (+48 more)

### Community 2 - "createClient"
Cohesion: 0.16
Nodes (39): POST(), deleteAnnouncement(), saveAnnouncement(), toggleAnnouncement(), tones, AnnouncementsPage(), setErrorStatus(), deleteFeedbackQuery() (+31 more)
...
Cohesion: 0.15
Nodes (20): ignoreErrorLog(), reopenErrorLog(), resolveErrorLog(), buildQuery(), ErrorsPage(), severities, severityTone, statuses (+12 more)

### Community 7 - "SignPdfTool.tsx"
Cohesion: 0.10
Nodes (32): ARROW_DELTAS, clamp(), LiveGeometry, PlacedElementView(), canvasToSignature(), CreatedSignature, DrawTab(), HANDWRITING_FONTS (+24 more)
...
Cohesion: 0.12
Nodes (26): aboutSchema, generateMetadata(), accessibilitySchema, generateMetadata(), contactSchema, generateMetadata(), generateMetadata(), generateMetadata() (+18 more)

### Community 10 - "data.ts"
Cohesion: 0.08
Nodes (44): AdminMemberView, AnalyticsSummary, AuditLogFilters, DataResult, isRecord(), numberValue(), OverviewData, parseAdminAnalyticsSummary() (+36 more)

### Community 11 - "ControlCenterMobileNav.tsx"
Cohesion: 0.07
Nodes (35): AdminLoginPage(), getSafeMessage(), LoginMessageKey, metadata, safeMessages, MaintenancePage(), metadata, AdminIcon() (+27 more)
...
Cohesion: 0.14
Nodes (17): FloatingIsland(), FloatingIslandProps, toggleClass(), handleInkStroke(), clampPct(), createInkElement(), deleteElement(), EditElementBase (+9 more)

### Community 15 - "tiles.ts"
Cohesion: 0.14
Nodes (16): CommandPaletteDialog(), CommandPaletteDialog, CommandPaletteTrigger(), PublicPdfToolsMenuClient(), L2MenuSurface, buildCommandPaletteIndex(), CommandPaletteItem, normalize() (+8 more)

### Community 16 - "resolve.ts"
Cohesion: 0.12
...
Cohesion: 0.06
Nodes (21): InkCanvas(), Point, RedactionLayer(), RedactionLayerProps, TextRunOverlay, TextRunOverlayProps, applyTextRunEdit, currentPageElements (+13 more)
...
Cohesion: 0.22
Nodes (14): HealthPage(), statusLabel, statusTone, BuildInfo, checkLibreOfficeConverter(), checkSupabaseDatabase(), checkSupabaseStorage(), getBuildInfo() (+6 more)
...
Cohesion: 0.08
Nodes (24): compressPagesToRange(), createPdfFromPages(), densityClasses, densityPreviewClasses, friendlyPageError(), getSuggestions(), PageInfo, ParsedRange (+16 more)
...
### Community 25 - "PageNumbersTool.tsx"
Cohesion: 0.08
Nodes (25): CORNER_PRESETS, estimateLabelSizePct(), LoadedPdf, NUMBER_FORMATS, NUMERAL_STYLES, PageNumbersTool(), runWithTimeout(), sanitizePdfFileName() (+17 more)
...
Cohesion: 0.10
Nodes (24): restyleSelectedRun(), createTextElement(), createWhiteoutElement(), bestOperatorAmong(), buildOperatorSpatialIndex(), cellKey(), matchDetectedRunToOperator(), matchDetectedRunToOperatorIndexed() (+16 more)

### Community 29 - "applyRedaction.ts"
Cohesion: 0.10
Nodes (28): handleApplyRedaction(), handleDetectSensitive(), RFC-5322, applyRedaction(), pageDrawsImages(), RedactionOutcome, RedactionTargetRun, assessRedactionCoverage() (+20 more)

### Community 30 - "MergePdfTool.tsx"
Cohesion: 0.12
Nodes (24): CleanupMessage, createFileId(), destroyPdfJsDoc(), getOutputPageSize(), getOutputStyleLabel(), getPageSizeType(), getSizeSignature(), isSmartFitFormat() (+16 more)

### Community 31 - "formXObjects.ts"
Cohesion: 0.12
Nodes (30): asNumber(), defaultTextState(), IDENTITY_MATRIX, isDelimiter(), isWhitespace(), Matrix2x3, multiplyMatrix(), TextShowOperatorKind (+22 more)

### Community 32 - "pipeline.ts"
Cohesion: 0.10
Nodes (34): HeicToJpegTool(), labels, Row, size(), L2UploadStage(), normalizeBasename(), photoExtension(), ascii() (+26 more)
...
Cohesion: 0.12
Nodes (28): applyEditPlanToBytes(), applyEditPlanToDocument(), applyMultiRunEditPlanToDocument(), assertApplicable(), buildFallbackOperatorText(), buildReplacementOperatorText(), copyStreamDictExceptLengthAndFilter(), EditPlanRejectedError (+20 more)
...
Cohesion: 0.09
Nodes (33): AnalyticsActivityPage(), AnalyticsPage(), formatDate(), AuditPage(), buildQuery(), entityTypes, AdminDataTable(), AdminEmptyState() (+25 more)

### Community 42 - "resolveFont"
Cohesion: 0.14
Nodes (17): resolveFont(), resolveFontMetrics(), collectPageTextOperators(), editFirstOperator(), prepareEdit(), blankedBytes(), buildDoc(), buildRotatedTextPage() (+9 more)
...
### Community 44 - "editPlan.ts"
Cohesion: 0.09
Nodes (37): loadEditEngine(), TextShowOperator, buildEditPlan(), bytesToCodes(), decodeCodes(), EditPlan, FallbackFontUse, rejectionReasonFor() (+29 more)
...
Cohesion: 0.20
Nodes (15): ContinueWorking(), QUICK_ACTION_SLUGS, RecentFileLink(), cachedSnapshot, clearRecentFiles(), getRecentFiles(), isBrowser(), isValidItem() (+7 more)
...
Cohesion: 0.05
Nodes (39): @cloudflare/workers-response-store, exifr, fast-xml-parser, firebase-admin, html2canvas, html2pdf.js, libheif-js, lucide-react (+31 more)
...
### Community 55 - "fontMetrics.ts"
Cohesion: 0.29
Nodes (12): asNumber(), FontMetricsSource, glyphAdvancePt(), parseCidWidthsArray(), resolveArrayMaybe(), resolveCidFontWidths(), resolveDictMaybe(), resolveSimpleFontWidthsArray() (+4 more)

### Community 56 - "scripts"
Cohesion: 0.07
Nodes (30): scripts, build, build:vinext, db:migrate, deploy:response-store, deploy:vinext, dev, dev:vinext (+22 more)
...
### Community 58 - "permissions.ts"
Cohesion: 0.14
Nodes (25): InboxPage(), formatDate(), MembersPage(), publicRoutes, isEnabled(), liveSettingKeys, settingMessageValue(), SettingsPage() (+17 more)
...
Cohesion: 0.09
Nodes (23): @cloudflare/vite-plugin, eslint, jsdom, devDependencies, @cloudflare/vite-plugin, eslint, jsdom, @playwright/test (+15 more)
...
### Community 76 - "inspect.ts"
Cohesion: 0.16
Nodes (22): collectPlistPairs(), inspectAaeXml(), KeyValue, noAaeEvidence(), nodeText(), operationKeys(), OrderedXmlNode, valuesMatching() (+14 more)
...
### Community 82 - "HeaderFooterTool.tsx"
Cohesion: 0.12
Nodes (22): HeaderFooterPreview(), ZoneOverlay(), ALIGNMENTS, estimateLabelSizePct(), HeaderFooterTool(), LoadedPdf, runWithTimeout(), sanitizePdfFileName() (+14 more)

### Community 83 - "pdfToWordStorage.ts"
Cohesion: 0.06
Nodes (51): deleteUpload(), GET(), POST(), trimmed(), GET(), isAuthorized(), GET(), converterBaseUrl() (+43 more)

### Community 84 - "CropPdfTool.tsx"
Cohesion: 0.14
Nodes (19): AnalyticsPageView(), PUBLIC_PAGE_ROUTES, useAnalytics(), ASPECT_PRESETS, CropPdfTool(), LoadedPdf, runWithTimeout(), sanitizePdfFileName() (+11 more)
...
### Community 92 - "edit-page-ops.test.ts"
Cohesion: 0.16
...
Cohesion: 0.41
Nodes (13): resolvePageIndices(), composeRotationDegrees(), cornerAnchorPct(), manualNativeAnchor(), normalizePageRotation(), toNativePoint(), visualPageSize(), embedTextFonts() (+5 more)
...
Cohesion: 0.18
Nodes (7): breadcrumbSchema, generateMetadata(), MergePdfPage(), MergePdfTool, softwareSchema, PublicPageShell(), L2PublicHeader()
...
Cohesion: 0.19
Nodes (8): generateMetadata(), PageParams, generateMetadata(), structuredData, PdfHeroVisual(), footerGroups, PublicFooter(), L2PublicFooter()

### Community 143 - "PageThumbnailSidebar.tsx"
Cohesion: 0.40
...
Cohesion: 0.17
Nodes (15): metadata, ProtectedAdminLayout(), AdminPage(), formatDate(), AdminMetricCard(), AdminStatusBadge(), getAnnouncements(), getOverviewData() (+7 more)
...
### Community 170 - "export.ts"
Cohesion: 0.22
Nodes (8): createShapeElement(), exportEditedPdf(), hexToRgb01(), normalizePageRotation(), PageRotation, toNativeBox(), toNativePoint(), visualPageSize()

### Community 178 - "EditElementView.tsx"
Cohesion: 0.26
...
### Community 200 - "analytics-range.ts"
Cohesion: 0.35
Nodes (9): AnalyticsRange, AnalyticsRangeKey, customRange(), monthStart(), parseCalendarDate(), previousMonthRange(), resolveAnalyticsRange(), shiftIsoDate() (+1 more)

### Community 201 - "sanitizeFileStem"
Cohesion: 0.33
Nodes (7): deleteUpload(), POST(), trimmed(), sanitizePdfFileName(), sanitizePdfFileName(), ensureExtension(), sanitizeFileStem()

### Community 202 - "metadata.ts"
Cohesion: 0.39
Nodes (8): first(), inspectMetadata(), METADATA_KEYS, numberValue(), record(), text(), timestamp(), LocalMetadata

### Community 203 - "Browser converter capability record"
Cohesion: 0.25
...
### Community 215 - "libheif.d.ts"
Cohesion: 0.40
Nodes (4): Channel, ImageHandle, LibHeif, libheif-js/libheif-wasm/libheif-bundle.mjs

## Knowledge Gaps
- **1274 isolated node(s):** `aboutSchema`, `accessibilitySchema`, `tones`, `entityTypes`, `colourTokens` (+1269 more)
...
- **Why does `createClient()` connect `createClient` to `permissions.ts`, `page.tsx`, `page.tsx`, `auth.ts`, `data.ts`, `page.tsx`, `ControlCenterMobileNav.tsx`, `withSeoOverride`, `pdfToWordStorage.ts`, `page.tsx`, `route.ts`?**
  _High betweenness centrality (0.039) - this node is a cross-community bridge._
- **Why does `withSeoOverride()` connect `withSeoOverride` to `page.tsx`, `page.tsx`, `getToolBlockedState`, `PublicPdfChrome.tsx`, `createClient`, `page.tsx`, `page.tsx`, `page.tsx`, `page.tsx`, `page.tsx`, `page.tsx`, `page.tsx`?**
  _High betweenness centrality (0.036) - this node is a cross-community bridge._
- **Why does `pageNumber()` connect `page.tsx` to `PdfToJpgTool.tsx`, `SplitPdfTool.tsx`, `page.tsx`, `MergePdfTool.tsx`?**
