...
## Corpus Check
- 410 files · ~539,525 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3008 nodes · 6421 edges · 176 communities (154 shown, 22 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 65 edges (avg confidence: 0.64)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `72584cbf`
...
Cohesion: 0.05
Nodes (74): HeaderFooterPreview(), ZoneOverlay(), describePosition(), PageNumberPreview(), describePosition(), WatermarkPreview(), ANCHOR_GRID, ANCHOR_LABELS (+66 more)

### Community 1 - "data.ts"
Cohesion: 0.04
Nodes (88): breadcrumbSchema, CompressPdfPage(), CompressPdfTool, generateMetadata(), softwareSchema, breadcrumbSchema, CropPdfPage(), CropPdfTool (+80 more)

### Community 2 - "page.tsx"
Cohesion: 0.11
Nodes (59): deleteAnnouncement(), saveAnnouncement(), toggleAnnouncement(), tones, AnnouncementsPage(), deleteFeatureFlag(), saveFeatureFlag(), toggleFeatureFlag() (+51 more)
...
Cohesion: 0.07
Nodes (34): AdminError(), GlobalError(), fraunces, inter, metadata, plexMono, viewport, PdfToolError() (+26 more)
...
Cohesion: 0.07
Nodes (40): ignoreErrorLog(), reopenErrorLog(), resolveErrorLog(), setErrorStatus(), buildQuery(), ErrorsPage(), severities, severityTone (+32 more)
...
Cohesion: 0.08
Nodes (34): ALIGNMENTS, estimateLabelSizePct(), HeaderFooterTool(), LoadedPdf, runWithTimeout(), sanitizePdfFileName(), CORNER_PRESETS, estimateLabelSizePct() (+26 more)
...
Cohesion: 0.12
Nodes (40): AdminMemberView, AnalyticsSummary, AuditLogFilters, DataResult, getAdminMembers(), getAnalyticsSummary(), getAnnouncements(), getAuditLogs() (+32 more)
...
Cohesion: 0.10
Nodes (28): clamp(), CropRectView(), describeRect(), Handle, resizeFromHandle(), ASPECT_PRESETS, CropPdfTool(), LoadedPdf (+20 more)

### Community 14 - "ControlCenterMobileNav.tsx"
Cohesion: 0.10
Nodes (27): EditElementView, EditElementViewImpl(), LiveGeometry, handleInkStroke(), restyleSelectedRun(), canResizeElement(), clampPct(), createInkElement() (+19 more)

### Community 15 - "AnalyticsProvider.tsx"
Cohesion: 0.09
Nodes (28): CommandPaletteDialog(), CommandPaletteDialog, CommandPaletteTrigger(), ContinueWorking(), QUICK_ACTION_SLUGS, RecentFileLink(), base, shard() (+20 more)

### Community 16 - "MicroDock.tsx"
Cohesion: 0.10
Nodes (23): generateMetadata(), PageParams, generateMetadata(), structuredData, PdfHeroVisual(), PublicCatalogPageShell(), groupActions(), ToolCategoryDetail() (+15 more)

### Community 17 - "export.ts"
Cohesion: 0.11
Nodes (27): RedactionLayerProps, handleApplyRedaction(), handleDetectSensitive(), RFC-5322, applyRedaction(), pageDrawsImages(), RedactionOutcome, RedactionTargetRun (+19 more)

### Community 18 - "page.tsx"
Cohesion: 0.07
Nodes (22): InkCanvas(), Point, applyTextRunEdit, currentPageElements, EditEngine, EditHistorySnapshot, EditPdfTool(), EditPreview (+14 more)
...
Cohesion: 0.12
Nodes (21): HealthPage(), statusLabel, statusTone, HomepagePage(), metadata, ProtectedAdminLayout(), AdminPage(), formatDate() (+13 more)
...
Cohesion: 0.11
Nodes (23): asNumber(), embeddedByDocument, encodeWithFallbackFont(), FallbackFontFamily, FallbackStyleHints, firstUnencodableChar(), getOrCreateFontsDict(), isReusableSubstitute() (+15 more)
...
Cohesion: 0.13
Nodes (23): AnalyticsPageView(), PUBLIC_PAGE_ROUTES, AnalyticsContext, AnalyticsContextValue, AnalyticsProvider(), debugOverrideEnabled(), doNotTrackEnabled(), PUBLIC_ANALYTICS_ROUTES (+15 more)

### Community 29 - "page.tsx"
Cohesion: 0.15
Nodes (22): EditElement, exportEditedPdf(), hexToRgb01(), normalizePageRotation(), PageRotation, toNativeBox(), toNativePoint(), visualPageSize() (+14 more)
...
Cohesion: 0.16
Nodes (23): AmbiguousSharedFormError, asNumber(), collectPageTextOperators(), countDocumentFormXObjectInvocations(), CyclicFormReferenceError, findFormInvocations(), FormInvocation, getPageContentStreamRefs() (+15 more)

### Community 32 - "JpgToPdfTool.tsx"
Cohesion: 0.16
Nodes (18): AuditPage(), buildQuery(), entityTypes, deleteFeedbackQuery(), InboxPage(), AdminEmptyState(), absoluteTime(), InboxClient() (+10 more)

### Community 33 - "page.tsx"
Cohesion: 0.14
Nodes (15): generateMetadata(), Home(), structuredData, trustItems, whyItems, ToolCategoryPage(), PdfToolsPage(), PdfToolLauncher() (+7 more)
...
Cohesion: 0.13
Nodes (22): ContentStreamToken, applyDifferences(), EncodingSource, findToUnicodeMap(), fontDescriptorOf(), FontKind, hexStringToCode(), hexStringToCodePoint() (+14 more)
...
Cohesion: 0.15
Nodes (16): AnalyticsActivityPage(), AnalyticsPage(), formatDate(), AdminDataTable(), AnalyticsBarList(), BarItem, AnalyticsPrivacyNotice(), AnalyticsTrendChart() (+8 more)

### Community 42 - "edit-pdf-privacy-shield.test.ts"
Cohesion: 0.11
Nodes (14): ConversionResult, SelectedFile, Stage, ConversionResult, SelectedFile, Stage, cx(), L2AdvancedDisclosure() (+6 more)
...
Cohesion: 0.15
Nodes (17): TextShowOperator, buildEditPlan(), bytesToCodes(), decodeCodes(), FallbackFontUse, rejectionReasonFor(), SUPPORTED_OPERATOR_KINDS, fallbackFontMetrics() (+9 more)
...
### Community 49 - "jsdom"
Cohesion: 0.17
Nodes (17): ExportFormat, ExtractTextTool(), FORMAT_EXTENSION, FORMAT_MIME, L2PanelLabel(), L2WorkspaceHeader(), buildCsvFromEntries(), buildJsonFromEntries() (+9 more)
...
Cohesion: 0.16
Nodes (16): asNumber(), defaultTextState(), IDENTITY_MATRIX, isDelimiter(), isWhitespace(), Matrix2x3, multiplyMatrix(), TextShowOperatorKind (+8 more)

### Community 55 - "Browser Certification"
Cohesion: 0.20
Nodes (16): asNumber(), compareAdvance(), compareAdvanceAcrossFonts(), FontMetricsSource, glyphAdvancePt(), parseCidWidthsArray(), resolveArrayMaybe(), resolveCidFontWidths() (+8 more)
...
Cohesion: 0.13
Nodes (12): TextRunOverlay, TextRunOverlayProps, PrivacyShieldMatch, scanForSensitiveInfo(), DetectedTextRun, findTextRunAtPoint(), isTextItem(), overlayFontSizePx() (+4 more)
...
Cohesion: 0.23
Nodes (8): getFormValue(), signInAdmin(), POST(), getAdminContext(), getClaimString(), isAdminRole(), VerifiedClaims, AdminContext

### Community 83 - "permissions.ts"
Cohesion: 0.28
Nodes (11): GET(), deleteUpload(), GET(), POST(), trimmed(), converterBaseUrl(), convertWordToPdf(), pdfFileNameFor() (+3 more)
...
Cohesion: 0.27
Nodes (11): checkPdfFileSize(), failureStatus(), isTransientFailure(), PdfUploadResult, removePdfUpload(), UploadFailure, uploadFailureMessage(), uploadPdfFileForConversion() (+3 more)
...
Cohesion: 0.31
Nodes (10): BuildInfo, checkLibreOfficeConverter(), checkSupabaseDatabase(), checkSupabaseStorage(), getBuildInfo(), getHealthSnapshot(), HealthCheck, HealthCheckStatus (+2 more)
...
Cohesion: 0.31
Nodes (9): checkWordFileSize(), failureStatus(), isTransientFailure(), isWordNamedFile(), UploadFailure, uploadFailureMessage(), uploadWordFileForConversion(), wait() (+1 more)
...
Cohesion: 0.39
Nodes (5): GET(), isAuthorized(), getSupabaseEnv(), SupabaseEnv, createStorageServerClient()
...
Cohesion: 0.39
Nodes (7): applyGeoCookie(), buildGeoCookieValue(), bypassesMaintenanceMode(), isMissingSupabaseEnv(), updateSession(), config, proxy()
...
Cohesion: 0.38
Nodes (4): buildDoc(), buildRotatedTextPage(), editFirstOperator(), fmt()
...
- **Why does `createClient()` connect `page.tsx` to `JpgToPdfTool.tsx`, `Design: Page Organizer, HTML to PDF, Text Extractor`, `page.tsx`, `PDF Workspace Rollout`, `edit-page-ops.test.ts`, `PageThumbnailSidebar.tsx`, `config.ts`, `page.tsx`, `Lumeo PDF Workspace`, `client.ts`, `page.tsx`?**
  _High betweenness centrality (0.056) - this node is a cross-community bridge._
- **Why does `dependencies` connect `@types/react-dom` to `robots.ts`, `eslint.config.mjs`, `toolWorkerClient.ts`, `elements.ts`, `verify-release.mjs`, `tokens.ts`?**
...
- **Should `data.ts` be split into smaller, more focused modules?**
  _Cohesion score 0.042133876996262316 - nodes in this community are weakly interconnected._
