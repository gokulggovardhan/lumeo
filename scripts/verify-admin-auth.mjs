...
const requiredFiles = [
  ...
  "supabase/migrations/20260919160201_admin_security_hardening.sql",
...
try {
  ...
  const hardeningMigration = read("supabase/migrations/20260919160201_admin_security_hardening.sql");
  for (const helper of [
    "current_admin_role",
    "is_active_admin",
    "is_owner",
