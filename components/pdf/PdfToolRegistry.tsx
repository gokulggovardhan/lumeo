...
export const pdfTools: PdfToolDefinition[] = [
  ...
  },
  {
    ...
    status: "live",
    browserNote: "Browser-only conversion",
    engineNote: "Local Office engine",
    accepted: "DOCX and DOC files",
    bullets: [
      "Preserves layout and fonts",
      "Handles tables and images",
      "Up to 250 MB",
      "Document is not uploaded for conversion",
    ],
  },
  {
    slug: "pdf-to-word",
    ...
    description: "Reconstruct PDF documents into editable Word files locally.",
    route: "/pdf/pdf-to-word",
    status: "live",
    browserNote: "Browser-only reconstruction",
    engineNote: "Local reconstruction",
    accepted: "one PDF file",
    bullets: [
      "Editable text where reliably reconstructable",
      "Preserves page geometry and graphics",
      "Up to 250 MB",
      "PDF is not uploaded for conversion",
    ],
  },
  {
    slug: "organize",
