// Small synchronous SHA-256 helper used for stable local PDF resource
// fingerprints. This is not used for authentication or security decisions;
// it avoids making PdfFontRegistry.resolve() asynchronous and adds no runtime
// dependency. The implementation follows FIPS 180-4's SHA-256 compression
// function and returns lowercase hexadecimal.
