...
export const lumeoTools: LumeoTool[] = [
  {
    ...
    actions: [
      ...
      { label: "Split by range", slug: "split-range", live: false },
      { label: "Reorder", slug: "reorder", live: false },
      { label: "Rotate", slug: "rotate", live: false },
      { label: "Remove pages", slug: "remove-pages", live: false },
      { label: "Extract pages", slug: "extract-pages", live: false },
      { label: "Insert PDF", slug: "insert-pdf", live: false },
    ],
  },
  {
    key: "distill",
  ...
  },
  {
    ...
    availability: "soon",
    actions: [
      { label: "Add text", slug: "add-text", live: false },
      { label: "Images", slug: "add-images", live: false },
      { label: "Shapes", slug: "shapes", live: false },
      { label: "Highlight", slug: "highlight", live: false },
  ...
  },
  {
    ...
    availability: "soon",
    actions: [
      { label: "Password", slug: "password", live: false },
      { label: "Unlock", slug: "unlock", live: false },
      { label: "Permissions", slug: "permissions", live: false },
  ...
  },
  {
    ...
    actions: [
      ...
      { label: "EPUB to PDF", slug: "epub-to-pdf", live: false },
    ],
  },
  {
    key: "recognize",
