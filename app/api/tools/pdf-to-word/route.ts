...
// This route brokers the conversion through the external LibreOffice
// service (see lib/converters/pdf-to-word.ts). The Cloudflare Worker mainly
// waits on network I/O; application/converter timeouts are the authoritative
// safety bounds for slow conversions.
