...
// Worker request. Conversion itself runs in the external LibreOffice service;
// this route mainly waits on network I/O. Cloudflare Workers do not impose a
// hard wall-clock limit on an incoming HTTP request while the client remains
// connected, so the converter/client timeouts are the authoritative bounds.
