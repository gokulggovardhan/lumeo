...
const softwareSchema = buildSoftwareApplicationSchema({
  name: "Lumeo PDF to JPG",
  description: "Export PDF pages as JPG, PNG, or WEBP images privately in your browser.",
  path: "/pdf/pdf-to-jpg",
  featureList: ["Page selection", "Quality and DPI control", "ZIP download for multiple pages", "No file upload"],
});
