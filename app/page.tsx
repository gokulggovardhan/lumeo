...
export async function generateMetadata(): Promise<Metadata> {
  return withSeoOverride("/", {
    ...
    description:
      "Merge, split, compress, and convert PDFs, images, and Word documents with browser-first tools. No account required.",
...
const whyItems = [
  {
    ...
    description: "Current document tools process files on your device, including Word ↔ PDF conversion.",
  },
  {
    icon: () => (
